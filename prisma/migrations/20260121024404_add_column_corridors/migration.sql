...
CREATE TABLE "new_BootcampConfig" (
    ...
    "corridorAfterCols" TEXT NOT NULL DEFAULT '[]',
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_BootcampConfig" ("corridorAfterRows", "displayTitle", "id", "seatDirection", "seatsPerRow", "totalRows", "updatedAt", "useCustomLayout") SELECT "corridorAfterRows", "displayTitle", "id", "seatDirection", "seatsPerRow", "totalRows", "updatedAt", "useCustomLayout" FROM "BootcampConfig";
